...
import {
    IEntryPoint,
    PackedUserOperation
} from "../../interfaces/draft-IERC4337.sol";
...
library ERC4337Utils {
    ...
    function combineValidationData(
        ...
        bool success = aggregator1 ==
            address(uint160(SIG_VALIDATION_SUCCESS)) &&
    ...
    function getValidationData(
        ...
        return (
            aggregator_,
            block.timestamp < validAfter || validUntil < block.timestamp
        );
    }
    ...
    function factory(
        ...
        return
            self.initCode.length < 20
                ? address(0)
                : address(bytes20(self.initCode[0:20]));
    }
    ...
    function paymasterVerificationGasLimit(
        ...
        return
            self.paymasterAndData.length < 52
                ? 0
                : uint128(bytes16(self.paymasterAndData[20:36]));
    }
    ...
    function paymasterPostOpGasLimit(
        ...
        return
            self.paymasterAndData.length < 52
                ? 0
                : uint128(bytes16(self.paymasterAndData[36:52]));
    }
