...
import "@openzeppelin/contracts@4.9.6/token/ERC721/extensions/IERC721Metadata.sol";
// import "@openzeppelin/contracts@4.9.6/utils/Address.sol";
import "../../utils/Context.sol";
import "@openzeppelin/contracts@4.9.6/utils/Strings.sol";
import "@openzeppelin/contracts@4.9.6/utils/introspection/ERC165.sol";
...
contract ERC721 is Context,Initializable, ERC165, IERC721, IERC721Metadata {
    ...
    // 注意修饰器为onlyInitializing，意思是，如果B合约被A合约继承，A合约同样有初始化函数，
    // 当A合约使用initializer修饰器，修饰器init函数。并且调用这个init函数之后，_initializing设为true.
    // 但B合约也需要初始化，但因为A合约的初始化函数的修饰器为onlyInitializing，所以B合约也可以正确被初始化成功
