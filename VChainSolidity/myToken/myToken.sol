...
import {ERC721Enumerable} from "./openzeppelin_l/contracts/token/ERC721/extensions/ERC721Enumerable.sol";
import {ERC721URIStorage} from "./openzeppelin_l/contracts/token/ERC721/extensions/ERC721URIStorage.sol";
...
import {ERC721Pausable} from "./openzeppelin_l/contracts/token/ERC721/extensions/ERC721Pausable.sol";
...
contract MyToken is Initializable,Ownable,ERC721, ERC721Pausable,ERC721Enumerable, ERC721URIStorage {
    ...
    // 那么别人无法再次进去这个函数（）。
    function initialize(bytes calldata _tokenName,bytes calldata _tokenSymbol) public initializer onlyOwner  {
