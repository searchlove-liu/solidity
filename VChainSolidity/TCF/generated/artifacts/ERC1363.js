export const Artifact_ERC1363 = /** @type {const} **/ ({
  "contractName": "ERC1363",
  "sourceName": "contracts/openzeppelin_l/contracts/token/ERC20/extensions/ERC1363.sol",
  "abi": [
    {
      "anonymous": false,
      "inputs": [
  ...
  "immutableReferences": {},
  "inputSourceName": "project/contracts/openzeppelin_l/contracts/token/ERC20/extensions/ERC1363.sol",
  "devdoc": {
    ...
    "methods": {
      ...
      "transferAndCall(address,uint256,bytes)": {
        "details": "Variant of {transferAndCall} that accepts an additional `data` parameter with no specified format. 用户调用transferAndCall函数，使用DCF购买NFT时，最后一个参数需要传入 tokenID + buyAmount 的hex格式 （tokenID和buyAmount 都是uint256类型），前缀为0x，总共长度为66字节。",
        "params": {
          "data": "tokenID + buyAmount (each uint256), 64 bytes total",
          "to": "NFT合约的地址，花费value的token购买“buyAmount”数量的NFT",
          "value": "花费的token数量,单位是最小单位,花费1个token,则value=1*10^9"
        }
      },
