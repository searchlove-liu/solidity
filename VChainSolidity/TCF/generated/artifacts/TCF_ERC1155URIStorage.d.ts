export declare const Artifact_TCF_ERC1155URIStorage: {
  ...
  "devdoc": {
    ...
    "methods": {
      ...
      "safeTransferFrom(address,address,uint256,uint256,bytes)": {
        "details": "See {IERC1155-safeTransferFrom}.没有实现 原erc1155的第四个参数是amount，但是我们这个合约中，每个tokenId对应的NFT是不同的，所以第四个参数改为某类NFT下的某个NFTid号"
      },
