export const TCF_NFT = [
  ...
  {
    inputs: [],
    name: "withdrawAddress_initialized",
    outputs: [
      {
        internalType: "uint8",
        name: "",
