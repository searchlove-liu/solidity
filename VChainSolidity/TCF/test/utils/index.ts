...
export function setupFixtures(provider: EthereumProvider) {
  return {
    async deployAll() {
      ...
      const testGasUsed =
        env.get<typeof artifacts.testGasUsed.abi>("testGasUsed");
      const TCF_NFTPrice =
        env.get<typeof artifacts.TCF_NFTPrice.abi>("TCF_NFTPrice");
      const test_TCF_ERC1155 =
        env.get<typeof artifacts.test_TCF_ERC1155.abi>("test_TCF_ERC1155");
      const test_TCF_ERC1155MintTime = env.get<
        typeof artifacts.test_TCF_ERC1155MintTime.abi
      >("test_TCF_ERC1155MintTime");
      const test_TCF_ERC1155URIStorage = env.get<
        typeof artifacts.test_TCF_ERC1155URIStorage.abi
      ...
      const SimpleTokenReceiver = env.get<
        typeof artifacts.SimpleTokenReceiver.abi
      >("SimpleTokenReceiver");
      const ERC1363Example =
